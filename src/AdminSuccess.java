...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		lblAdminSection.setForeground(Color.decode("#FFFFFF"));
		...
		btnViewLibrarian.setForeground(Color.decode("#FFFFFF"));
		btnViewLibrarian.setBackground(Color.decode("#AEAEAE"));
		...
		btnDeleteLibrarian.setForeground(Color.decode("#FFFFFF"));
		btnDeleteLibrarian.setBackground(Color.decode("#AEAEAE"));
