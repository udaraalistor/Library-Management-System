...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		lblAddBooks.setForeground(Color.decode("#FFFFFF"));
		lblAddBooks.setFont(new Font("Tahoma", Font.PLAIN, 20));
		
		JLabel lblCallNo = new JLabel("Call No:");
		lblCallNo.setForeground(Color.decode("#FFFFFF"));
		...
		lblAuthor.setForeground(Color.decode("#FFFFFF"));
		
		JLabel lblPublisher = new JLabel("Publisher:");
		lblPublisher.setForeground(Color.decode("#FFFFFF"));
		
		JLabel lblQuantity = new JLabel("Quantity:");
		lblQuantity.setForeground(Color.decode("#FFFFFF"));
		...
		btnAddBooks.setForeground(Color.decode("#FFFFFF"));
		btnAddBooks.setBackground(Color.decode("#AEAEAE"));
		...
		btnBack.setBackground(Color.decode("#AEAEAE"));
