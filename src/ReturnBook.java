...
public class ReturnBook extends JFrame {
	...
	public ReturnBook() {
		...
		lblReturnBook.setForeground(Color.decode("#FFFFFF"));
		lblReturnBook.setFont(new Font("Tahoma", Font.PLAIN, 18));

		
		JLabel lblBookCallno = new JLabel("Book Callno:");
		lblBookCallno.setForeground(Color.decode("#FFFFFF"));
		lblBookCallno.setFont(new Font("Tahoma", Font.PLAIN, 15));
		
		JLabel lblStudentId = new JLabel("Student Id:");
		lblStudentId.setForeground(Color.decode("#FFFFFF"));
