...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		btnViewBooks.setForeground(Color.decode("#FFFFFF"));
		btnViewBooks.setBackground(Color.decode("#AEAEAE"));
		...
		btnIssueBook.setForeground(Color.decode("#FFFFFF"));
		btnIssueBook.setBackground(Color.decode("#AEAEAE"));
		...
		btnViewIssuedBooks.setForeground(Color.decode("#FFFFFF"));
		btnViewIssuedBooks.setBackground(Color.decode("#AEAEAE"));
		...
		btnReturnBook.setForeground(Color.decode("#FFFFFF"));
		btnReturnBook.setBackground(Color.decode("#AEAEAE"));
		...
		btnLogout.setBackground(Color.decode("#AEAEAE"));
