...
public class Library extends JFrame {
	...
	public Library() {
		...
		JLabel lblLibraryManagement = new JLabel("NSBM Library Management System Group31");
		lblLibraryManagement.setForeground(Color.decode("#FFFFFF"));
		lblLibraryManagement.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JButton btnAdminLogin = new JButton("Admin Login");
		btnAdminLogin.setForeground(Color.decode("#FFFFFF"));
		btnAdminLogin.setBackground(Color.decode("#AEAEAE"));
		...
		btnLibrarianLogin.setForeground(Color.decode("#FFFFFF"));
		btnLibrarianLogin.setBackground(Color.decode("#AEAEAE"));
