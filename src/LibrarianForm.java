...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		lblAddLibrarian.setForeground(Color.decode("#FFFFFF"));
		...
		lblAddress.setForeground(Color.decode("#FFFFFF"));
		
		JLabel lblCity = new JLabel("City:");
		lblCity.setForeground(Color.decode("#FFFFFF"));
		
		JLabel lblContactNo = new JLabel("Contact No:");
		lblContactNo.setForeground(Color.decode("#FFFFFF"));
